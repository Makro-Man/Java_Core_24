...
public class Schedule implements Serializable {
    ...
    private final Movie technicalBreakMovie = new Movie("Maintenance break", technicalBreakTime);
    ...
    public boolean addSeance(Movie movie) throws IllegalTimeFormatException {
        ...
        if (isSeanceTimeFree(seance)) {
            ...
            System.err.println("Adding a session to the schedule is impossible, because this time is taken!");
            return false;
        }
    }
    ...
    public boolean removeSeance(Seance removingSeance) throws IllegalTimeFormatException {
        ...
        if (removingSeanceFound.isPresent()) {
            ...
            System.err.println("The entered session is not in the schedule!");
            return false;
        }
    }
