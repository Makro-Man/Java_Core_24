...
public class Hall implements Comparable<Hall>, Serializable {
    ...
    public static Hall inputHall() {
        ...
        if (name.equals("")) {
            System.err.println("The name of the cinema has been entered incorrectly!");
            name = "Some unnamed cinema hall";
        }
    ...
    public boolean removeTimeTableFromHall() {
        ...
        if (isDone) {
            System.out.println("Opening hours successfully removed from the cinema " + name + "!");
            return true;
        } else
            return false;
    }
    ...
    public boolean addScheduleToHall() throws IllegalTimeFormatException {
        ...
        if (hallTimeTable.findDayInTimeTable(day).isPresent()) {
            ...
            if (isScheduleTimeNonWorkable(day, hallTimeTable, schedule)) {
                ...
                System.out.println("Schedule of sessions on " + day.toLiteral(true) + " successfully added to the cinema " + name + "!");
                return true;
            } else {
                System.err.println("Adding a Session Schedule to " + day.toLiteral(true) + " to the cinema " + name
                        + " impossible, because there are sessions outside of cinema hall hours!");
                return false;
            }
        } else {
            System.err.println(day.toLiteral(true) + " missing from the work schedule!");
            return false;
        }
    }
    ...
    public boolean removeScheduleFromHall() {
        ...
        if (hallScheduleEntryFound.isPresent()) {
            ...
            System.out.println("Schedule of sessions on " + day.toLiteral(true) + " successfully removed from the cinema " + name + "!");
            return true;
        } else {
            System.err.println(day.toLiteral(true) + " missing from the work schedule!");
            return false;
    ...
    public void viewHallSchedule() {
        System.out.print("Cinema schedule " + name + ":");
    ...
    public String toString() {
        if (name == "Some unnamed cinema hall") {
            return (String) name;
        } else
